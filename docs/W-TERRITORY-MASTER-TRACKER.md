...
**Status:** Tracker v24 (2026-05-30). Model LOCKED (v16, 2026-05-28). Phase 1 + Phase 2 + P-LIFECYCLE Landing 1 SHIPPED; P-LIFECYCLE Landing 2 SHIPPED (primitive `2ca82c6` + sync hooks `433c553`); F-NIGHTLY-SYNC-TIMEOUT-6H fixes 1+2+4 applied (`c77ce01`, awaiting first-night confirmation); Landing 3 (Events 4 + 7) remains. This document is the authoritative spec for territory + lead routing.
