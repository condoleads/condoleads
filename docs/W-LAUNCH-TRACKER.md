...
| `docs/W-LEADS-UI-POLISH-TRACKER.md` | OPEN 2026-05-12 (v1; scope locked) | L1 lead_origin_route badge swap-in + L2 hierarchy chain render (area_manager + tenant_admin) + L3 activity panel discoverability |
