...
export default function HomePageComprehensiveClient({ tenantId, brandName, wordmarkStyle, agent, stats, topAreas, access, assistantName }: Props) {
  return (
    <div style={{ minHeight: '100vh', background: '#060b18' }}>
      ...
      {/* LANE-B BUILD 2 (2026-07-09): revive the topAreas prop as a
          crawlable muni-anchor grid. Cards from fetchTopAreas are
          type='municipality' (see stats-fetcher.ts:175). Silent-omit
          when empty. Real muni slugs. */}
