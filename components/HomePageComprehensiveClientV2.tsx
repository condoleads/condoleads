...
function HeroWordmark({ wordmarkStyle, brandName }: { wordmarkStyle: string; brandName: string | null }) {
  ...
  // (prefix-glow + heart-on-i). Same fade-up reveal. 'aiglow' does NOT
  // flip isHeroTenant() -- WALLiam UI suite stays WALLiam-only.
    ...
    <div style={{ width: '100%', maxWidth: 680, margin: '0 auto' }}>
      <div style={{
        ...
        background: focused
          ...
          : 'linear-gradient(135deg, rgba(245,158,11,0.55), rgba(59,130,246,0.55), rgba(16,185,129,0.55))',
