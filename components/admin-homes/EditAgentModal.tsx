...
// Adapted from components/admin/EditAgentModal.tsx
// WALLiam additions: VIP config section
'use client'
  ...
  async function loadAgent() {
    ...
    try {
      ...
      setFormData({
        ...
        ai_free_messages: a.ai_free_messages ?? 1,
        vip_auto_approve: a.vip_auto_approve ?? false,
        ai_auto_approve_limit: a.ai_auto_approve_limit ?? 2,
        ai_manual_approve_limit: a.ai_manual_approve_limit ?? 3,
        ai_hard_cap: a.ai_hard_cap ?? 10,
      })
    ...
    try {
      const res = await fetch(`/api/admin/agents/${agentId}`, {
        ...
        body: JSON.stringify({
          ...
          cell_phone: formData.cell_phone, office_phone: formData.office_phone,
          whatsapp_number: formData.whatsapp_number, title: finalTitle,
          brokerage_name: formData.brokerage_name, brokerage_address: formData.brokerage_address,
          license_number: formData.license_number, subdomain: formData.subdomain,
          custom_domain: formData.custom_domain || null, bio: formData.bio || null,
