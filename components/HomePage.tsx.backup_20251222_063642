...
export function HomePage({ agent, buildings, developments = [] }: HomePageProps) {
  return (
    <div className="min-h-screen">
      ...
      {/* Buildings Grid */}
      <BuildingsGrid buildings={buildings} developments={developments} agentName={agent.full_name} />
