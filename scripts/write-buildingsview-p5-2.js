// scripts/write-buildingsview-p5-2.js
// W-TERRITORY-MASTER P5.2: Write components/admin-homes/cockpit/territory/BuildingsView.tsx
// as a complete new file. ASCII-only payload. Atomic write with post-write sanity.
//
// v2: uses /api/admin-homes/geo-tree (existing) for tree-mode dropdowns,
//     uses card.id from the list-endpoint response directly (no card-lookup roundtrip).
...
if (fs.existsSync(TARGET)) {
  ...
  if (existing === content) {
    console.log('File already at target state. No write.')
    process.exit(0)
  }
...
console.log('  Has "BuildingsView":', written.includes('export default function BuildingsView'))
console.log('  Has tree mode:', written.includes("mode === 'tree'"))
console.log('  Has search mode:', written.includes("mode === 'search'"))
console.log('  Has bulk assign:', written.includes('submitAssign'))
console.log('  Has deactivate:', written.includes('deactivateCard'))
console.log('  Uses geo-tree endpoint:', written.includes('/api/admin-homes/geo-tree'))
console.log('  Uses card.id (no card-lookup):', written.includes('building.card.id'))
