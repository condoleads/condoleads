  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '120px 24px', color: '#fff' }}>
      ...
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        The one-time setup fee is non-refundable once onboarding has commenced. If you cancel before onboarding begins, a full refund will be issued within 5 business days.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>Monthly Subscription</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        Monthly subscriptions can be cancelled at any time. Cancellations take effect at the end of the current billing period. No partial refunds are issued for unused days within a billing period.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>First Month Free</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        All plans include the first month free. No charge is made until the second month of service.
      </p>
