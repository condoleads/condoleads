export default function TermsOfService() {
  return (
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '120px 24px', color: '#fff' }}>
      ...
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        You may cancel your subscription at any time. Cancellations take effect at the end of the current billing period. Setup fees are non-refundable once onboarding has commenced.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>4. Acceptable Use</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        The platform may only be used by licensed real estate professionals or brokerages. You agree not to misuse the service, misrepresent your identity, or use the platform for any unlawful purpose.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>5. Data & Privacy</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        Lead data collected through the platform belongs to the subscribing agent or brokerage. 01leads does not sell or share lead data with third parties. See our Privacy Policy for full details.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>6. Limitation of Liability</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 32 }}>
        01leads is not liable for missed leads, lost business, or any indirect damages arising from use of the platform. The service is provided as-is without guarantees of specific business outcomes.
      </p>

      <h2 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#fff' }}>7. Contact</h2>
      <p style={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.75 }}>
        01leads (Individual Entrepreneur LINKA, ID: 304805726)<br />
