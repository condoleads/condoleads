  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="fixed top-0 left-0 z-40 h-full w-64 bg-white border-r border-gray-200 hidden lg:block">
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-3 py-4 space-y-1">
            ...
            <a href="/dashboard/buildings" className="flex items-center px-3 py-2 bg-blue-50 text-blue-600 rounded-lg">
      ...
      <div className="flex-1 lg:ml-64">
        <BuildingsClient buildings={buildings} agentId={agent.id} />
      </div>
    </div>
  )
}
