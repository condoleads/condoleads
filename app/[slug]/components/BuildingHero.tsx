    ...
    <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-24">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2 sm:gap-3 md:gap-4 w-full">
          ...
          <div className="bg-emerald-500/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-emerald-400/30 hover:bg-emerald-500/25 transition">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 text-emerald-300">{activeSalesCount}</p>
            <p className="text-sm opacity-80">For Sale</p>
          </div>
          
          <div className="bg-sky-500/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-sky-400/30 hover:bg-sky-500/25 transition">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 text-sky-300">{activeRentalsCount}</p>
          ...
          <div className="bg-amber-500/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-amber-400/30 hover:bg-amber-500/25 transition">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 text-amber-300">
              {avgSalePrice > 0 ? formatPriceShort(avgSalePrice) : ''}
            </p>
            <p className="text-sm opacity-80">Avg Price</p>
          </div>

          <div className="bg-purple-500/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-400/30 hover:bg-purple-500/25 transition">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 text-purple-300">
              {avgDaysOnMarketSale > 0 ? Math.round(avgDaysOnMarketSale) : ''}
            </p>
            <p className="text-sm opacity-80">Days (Sale)</p>
          </div>

          <div className="bg-indigo-500/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-indigo-400/30 hover:bg-indigo-500/25 transition">
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 text-indigo-300">
