      ...
      <div className="max-w-7xl mx-auto pb-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mt-8 px-4">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <GatedContent shouldGate={shouldGate} sectionName="Property Details" buildingId={listing.building_id} listingId={listing.id} listingAddress={listing.unparsed_address || ''}>
            ...
            <GatedContent shouldGate={shouldGate} sectionName="Room Dimensions" buildingId={listing.building_id} listingId={listing.id} listingAddress={listing.unparsed_address || ''}>
                <RoomDimensions rooms={rooms} />
              </GatedContent>
            )}

            {unitHistory && unitHistory.length > 0 && (
            <GatedContent shouldGate={shouldGate} sectionName="Transaction History" buildingId={listing.building_id} listingId={listing.id} listingAddress={listing.unparsed_address || ''}>
                <UnitHistory
                  history={unitHistory}
            ...
            {isClosed && (
            <GatedContent shouldGate={shouldGate} sectionName="Price History" buildingId={listing.building_id} listingId={listing.id} listingAddress={listing.unparsed_address || ''}>
                <PriceHistory
