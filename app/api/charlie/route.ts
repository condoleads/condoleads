...
CURRENT GEO ANALYTICS (pre-loaded — use this data directly, do NOT call get_market_analytics again but DO still call search_listings, search_buildings and other tools as needed):
